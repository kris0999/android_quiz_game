...
public class TalkLevelActivity extends AppCompatActivity implements ILevelLaunch {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        easyBtnView = findViewById(R.id.talkEasyButton);
        aveBtnView = findViewById(R.id.talkAverageButton);
        diffBtnView = findViewById(R.id.talkDifficultButton);

        setLevelState(userInfo.talkToMeLevel);
    }
