...
public class OtherLevelActivity extends AppCompatActivity implements ILevelLaunch {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_level);
        easyBtnView = findViewById(R.id.otherEasyButton);
        aveBtnView = findViewById(R.id.otherAverageButton);
        diffBtnView = findViewById(R.id.otherDifficultButton);
